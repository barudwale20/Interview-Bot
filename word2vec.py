...
print (similarity('What are your research interests?', 'My research field is Machine Learning', False))
print (similarity('What are your research interests?', 'My research field is Machine Learning', True))
